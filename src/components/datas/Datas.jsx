...
import { ScDatas } from "./datas.styled";
                    ...
                    <div className="datas__milestone-container">
                        <div className="datas__milestone-container-1">
                            <div className="milestone__card-1">
                                <span className="milestone__card-number">
                                    154
                                </span>
                        ...
                        <div className="datas__milestone-desc">
                            <p className="datas__milestone-desc-p">
                                ...
                                adipisicing elit. Nemo dolorem ea earum error
                                soluta sit ullam, quo optio illum assumenda! A
                                quo quibusdam excepturi, provident corrupti at
                                autem doloribus nesciunt.
                            </p>
                            <p className="datas__milestone-desc-p">
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Quis commodi vero repellendus
                                id, dolore saepe.
                            </p>
                        </div>
                    </div>
