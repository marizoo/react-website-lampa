                    ...
                    <div className="reviews__card-container">
                        ...
                        <div className="reviews__card-card">
                            <div className="reviews__card-desc">
                                Lorem ipsum, Libero maiores molestiae provident
                                dolore at ducimus nobis? Consequatur nisi
                                facilis ratione, adipisci deleniti, rem
                        ...
                        <div className="reviews__card-card">
                            <div className="reviews__card-desc">
                                ...
                                adipisicing elit. Consequatur nisi facilis
                                ratione, adipisci deleniti, rem voluptas,
                                corporis cupiditate illum provident earum
                                veniam!
                            </div>
                        ...
                        <div className="reviews__card-card">
                            <div className="reviews__card-desc">
                                ...
                                provident dolore at ducimus nobis rem voluptas,
                                corporis cupiditate illum provident earum
                                veniam!
                            </div>
